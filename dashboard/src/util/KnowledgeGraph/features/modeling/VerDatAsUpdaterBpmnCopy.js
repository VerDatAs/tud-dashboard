...
VerDatAsUpdater.prototype.updateDiConnection = function (di, newSource, newTarget) {
...
VerDatAsUpdater.prototype.updateConnectionWaypoints = function (connection) {
  connection.businessObject.di.set('waypoint', this._verDatAsFactory.createDiWaypoints(connection.waypoints))
}
