...
class ilVerDatAsDshPluginGUI extends ilPageComponentPluginGUI
{
    ...
    public function insert(): void
    {
        ...
        $customHtml = "<div class='ilFormHeader'>" .
            "<h2 class='ilHeader'>Include VerDatAs Dashboard</h2>" .
            "<div class='ilHeaderDesc'>" .
                "<p class='alert alert-info' style='margin-top: 20px;'>You are about to include the VerDatAs dashboard into your course. Press <strong>[Save]</strong> to proceed, or <strong>[Cancel]</strong> to abort.</p>" .
                "<h3 style='margin-bottom: 10px;'>Preview (Scaled):</h3>" .
                "<div style='background: #fff; margin-bottom: 10px;'><img src='" . $this->getPlugin()->getDirectory() . "/templates/assets/preview.jpg" . "' width='800' style='max-width: 100%;'></div>" .
            "</div>" .
        "</div>";
    ...
    public function edit(): void
    {
        ...
        $customHtml = "<div class='ilFormHeader'>" .
            "<h2 class='ilHeader'>Edit VerDatAs Dashboard</h2>" .
            "<div class='ilHeaderDesc'>" .
            "<p class='alert alert-info' style='margin-top: 20px;'>Currently, there are no options to edit the VerDatAs dashboard. Press <strong>[Cancel]</strong> to return and use the delete function to remove it.</p>" .
            "<h3 style='margin-bottom: 10px;'>Preview (Scaled):</h3>" .
            "<div style='background: #fff; margin-bottom: 10px;'><img src='" . $this->getPlugin()->getDirectory() . "/templates/assets/preview.jpg" . "' width='800' style='max-width: 100%;'></div>" .
            "</div>" .
            "</div>";
