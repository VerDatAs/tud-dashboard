...
```php
//...
use srag\RemovePluginDataConfirm\VerDatAsDsh\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\VerDatAsDsh\x\RepositoryObjectPluginUninstallTrait;
//...
